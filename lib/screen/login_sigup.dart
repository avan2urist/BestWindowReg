...
import 'package:registration/config/pallete.dart';
      ...
      body: Stack(
        children: [
          ...
          Positioned(
            ...
            child: Column(
              children: [
                 Text(isSignupScreen == true ? 'Or sign up with': 'Or sign in with'),
                Container(
  ...
  Container buildSignInSection() {
    return Container(
                    ...
                    child: Column(
                      children: [
                        buildTextField(
                            Icons.email, 'info@demori.com', false, true),
                        buildTextField(
                            Icons.password, '**********', true, false),
                        Row(
